class Client < ActiveRecord::Base
  attr_accessible :comment, :cr, :dop, :jmbg, :ms, :name, :oib, :profession, :sex, :surname, :title, :user_id, :change_user_id, :phones_attributes, :emails_attributes, :addresses_attributes, :invoices_attributes
